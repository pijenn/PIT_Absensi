        ...
        <>
            ...
            >
                <div className="w-full">
                    ...
                    <div className="w-fit mx-auto text-white mt-4 text-[28px]" >
                    ...
                    <div className="w-fit mx-auto">
                        <button className="bg-red-500 hover:bg-red-400 text-white px-20 py-2 rounded-full active:bg-red-700 text-[24px]">Mulai</button>
                    </div>
                </div>
            </div>
        </>
